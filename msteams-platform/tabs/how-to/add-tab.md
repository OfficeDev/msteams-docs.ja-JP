...
---
# <a name="create-a-tab-using-app-studio"></a>アプリ Studio を使用してタブを作成する

> [!TIP]
> すばやく開始する方法をお探しですか? Microsoft Teams ツールキットを使用して、 [個人](../../build-your-first-app/build-personal-tab.md) または [ [チャネルとグループ](../../build-your-first-app/build-channel-tab.md) ] タブを作成します。
