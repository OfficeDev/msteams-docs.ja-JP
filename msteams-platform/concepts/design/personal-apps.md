---
title: 個人用アプリをデザインする
description: Teams 個人用アプリを設計して Microsoft Teams UI キットを入手する方法、ダッシュボード、フォーム、モバイルおよびデスクトップ エクスペリエンス用のタスク ボードなどのコンポーネントを作成する方法について説明します。 個人用アプリを開発するためのベスト プラクティスについて説明します。
