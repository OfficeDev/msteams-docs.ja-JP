...
description: Postman を使用して、チームのリソース固有の同意Teamsする方法
...
ms.locfileid: "52994415"
---
# <a name="test-team-rsc-postman-collection-json"></a><span data-ttu-id="aab0e-104">テスト チーム RSC Postman コレクション JSON</span><span class="sxs-lookup"><span data-stu-id="aab0e-104">Test team RSC Postman collection JSON</span></span>
