---
title: チャットでリソース固有の同意をテストTeams
description: Postman を使用して、チャットのリソース固有の同意Teamsする方法
...
---
# <a name="test-chat-rsc-postman-collection-for-json"></a><span data-ttu-id="773b2-104">JSON のテスト チャット RSC Postman コレクション</span><span class="sxs-lookup"><span data-stu-id="773b2-104">Test chat RSC Postman collection for JSON</span></span>
