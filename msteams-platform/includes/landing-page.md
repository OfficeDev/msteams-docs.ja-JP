...
<div id="main" class="v2">
    <div class="container">
        <h1>Microsoft Teams 開発者プラットフォーム</h1>
        <ul class="pivots">
            <li>
                ...
                <ul id="get-started" class="cardsF panelContent singlePanelContent" style="display:flex!important;">
                    <li>
                        <div class="container intro" style="margin-top:-20px;">
                            <h2>Microsoft Teams プラットフォームでアプリの作成を始めてみましょう</h2>
                        </div>
                    </li>
                    <li>
                        <div class="cardSize">
                        ...
                        <div class="cardSize">
                            <div class="cardPadding">
                                <div class="card">
                                    ...
                                    <div class="cardText">
                                        <h3 style="font-size: 1.15rem">初めてのアプリを構築する</h3>
                                        <hr />
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="/microsoftteams/platform/tutorials/get-started-nodejs-app-studio">Node.js を使用して開始する</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="/microsoftteams/platform/tutorials/get-started-dotnet-app-studio">.NET/C# を使用して開始する</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cardSize">
                            <div class="cardPadding">
                                <div class="card">
                                    ...
                                    <div class="cardText">
                                        <h3 style="font-size: 1.15rem">コミュニティとつながる</h3>
                                        <hr />
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="https://developer.microsoft.com/microsoft-teams/blogs/">Microsoft Teams 開発者ブログ</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="https://aka.ms/microsoftteamscommunitycall">Microsoft Teams コミュニティ コール</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                            href="/microsoftteams/platform/feedback">フィードバックとサポート</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cardSize">
                            <div class="cardPadding">
                                <div class="card">
                                    ...
                                    <div class="cardText">
                                        <h3 style="font-size: 1.15rem">トレーニングとガイド付き学習</h3>
                                        <hr />
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="https://docs.microsoft.com/learn/modules/intro-microsoft-teams-apps/">Teams 用アプリ作成の概要</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="https://docs.microsoft.com/learn/modules/embedded-web-experiences/">タブによる埋め込み Web エクスペリエンスの作成</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                            href="https://www.youtube.com/c/MicrosoftTeamsPlatform">アプリ開発者向けトレーニング ビデオ (YouTube)</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <li>
                ...
                <ul id="samples-demos-templates">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>社内コミュニケーター アプリ</h3>
                                                    <p>社内チームがチャットによって従業員へのメッセージを作成および送信できます</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>お祝いアプリ</h3>
                                                    <p>チームのメンバーが互いに誕生日や記念日などの定期的なイベントをお祝いする際に役立ちます</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>FAQ プラス ボット</h3>
                                                    <p>FAQ ボットは Q&A ボットですが、ボットが役立たないときには人間が介在するようにします</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HR サポート ボット</h3>
                                                    <p>HRy Q&A ボットですが、ボットが役立たないときには HR チームが介在するようにします</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SharePoint リスト検索アプリ</h3>
                                                    <p>SharePoint リストを検索して、アイテムをアダプティブ カードとして Teams に挿入します</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>カスタム ステッカー アプリ</h3>
                                                    <p>チーム用または組織用のカスタム ステッカーを追加します</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>アイスブレーカー ボット</h3>
                                                    <p>会合のためにチームのメンバーを毎週無作為にペアリングすることによって、チームの親密感を深めることができます</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>スクラム状態ボット</h3>
                                                    <p>チームが非同期的なスクラム会議を実行し、更新情報を共有できます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>クラウドソーサー ボット</h3>
                                                    <p>チームが、組織のメンバーから共同で入手したクエリ情報を取得できます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>専門家検索ボット</h3>
                                                    <p>チームが、スキル、関心、教育に基づいて社内の専門家を見つけることができます。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Moodle の Teams への統合</h3>
                                                    <p>Microsoft Teams に Moodle サーバーを接続します</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#connectors">シフト コネクタ</a>
                        <ul id="connectors" class="cardsC">
                            <li>
                                <div class="container intro" style="margin-top:-20px;">
                                    <h2>すぐに使用できるシフト コネクタ</h2>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Kronos 対応シフト コネクタ</h3>
                                                    <p>Kronos WFM システムから Teams シフトへのシームレスな統合を提供します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>JDA 対応シフト コネクタ</h3>
                                                    <p>JDA (BlueYonder) WFM システムから Teams シフトへのシームレスな統合を提供します。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-samples-hello-world-csharp">C#/.NET バージョン</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-samples-hello-world-nodejs">Node.js バージョン</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Teams 会話ボット</h3>
                                                <p>一般的な会話イベントの実例を示すボット</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/microsoft/BotBuilder-Samples/tree/master/samples/csharp_dotnetcore/57.teams-conversation-bot">C#/.NET バージョン</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/microsoft/BotBuilder-Samples/tree/master/samples/javascript_nodejs/57.teams-conversation-bot">JavaScript/Node.js バージョン</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>メッセージング拡張機能: アクション コマンド</h3>
                                                <p>アクション コマンドを使用したメッセージング拡張機能</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/microsoft/BotBuilder-Samples/tree/master/samples/csharp_dotnetcore/51.teams-messaging-extensions-action">C#/.NET バージョン</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/microsoft/BotBuilder-Samples/tree/master/samples/javascript_nodejs/51.teams-messaging-extensions-action">Node.js バージョン</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>メッセージング拡張機能: 検索コマンド</h3>
                                                <p>検索コマンドを使用したメッセージング拡張機能</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/microsoft/BotBuilder-Samples/tree/master/samples/csharp_dotnetcore/52.teams-messaging-extensions-search-auth-config">C#/.NET バージョン</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/microsoft/BotBuilder-Samples/tree/master/samples/javascript_nodejs/52.teams-messaging-extensions-search-auth-config">Node.js バージョン</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Office 365 コネクタ</h3>
                                                <p>Microsoft Teams にカードをプッシュするコネクタを使用する MVC アプリ</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-connector-csharp">C#/.NET バージョン</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-connector-nodejs">Node.js バージョン</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>認証</h3>
                                                <p>さまざまな認証シナリオを処理するためのパターンを示します。</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-auth-node">Node.js バージョン</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Graph + Teams</h3>
                                                <p>Microsoft Teams と Graph を組み合わせる</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                        href="https://github.com/microsoftgraph/csharp-teams-sample-graph/tree/master/source">C#/.NET バージョン</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                        href="https://github.com/microsoftgraph/csharp-teams-sample-graph/tree/master/Node">Node.js バージョン</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>送信 Webhook</h3>
                                                <p>サンプルのカードを送信 webhook に返す MVC アプリ</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                        href="https://github.com/OfficeDev/microsoft-teams-sample-outgoing-webhook">C#/.NET バージョン</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="#demos">デモ アプリ</a>
                        <ul id="demos" class="cardsI panelContent">
                            <li>
                                <div class="container intro" style="margin-top:-20px;">
                                    <h2>複数の機能の用例を示す複雑なアプリ</h2>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>多機能アプリ</h3>
                                                <p>利用可能な Teams アプリ機能のほとんどすべての用例を示す複雑なアプリ</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-complete-node">Node.js バージョン</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-complete-csharp">C#/.NET バージョン</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>会社のコミュニケーション</h3>
                                                <p>組織のコミュニケーションと通知の例</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Cross%20Vertical/CompanyCommunicator">社内コミュニケーター</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Cross%20Vertical/NotificationBot">通知ボット</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-faqbot">FAQ ボット</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>航空会社シナリオ</h3>
                                                <p>航空会社の日常業務の用例を示す 5 つの複雑な .NET/C# ボットのコレクション</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Airline/FleetInfoBot">航空機情報ボット</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Airline/FlightInfo">運行情報ボット</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Airline/BaggageInfo">手荷物情報ボット</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Airline/FlightTeamCreation">運行チーム作成</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Airline/PassengerInfo">旅客情報ボット</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>全般的な基幹業務</h3>
                                                <p>ビジネス上の問題を解決するために複数のプラットフォーム機能を組み合わせる例を示すアプリ </p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-todo">ToDo アプリ</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Cross%20Vertical/PollingBot">投票ボット</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Manufacturing">在庫管理</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Professional%20Services">従業員休暇アプリ</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>情報技術</h3>
                                                <p>Teams アプリからチームを管理する </p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-adminbot-csharp">チーム管理ボット</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a
                                                        href="/javascript/api/@microsoft/teams-js/?view=msteams-client-js-latest">ドキュメント</a>
                                                </p>
                                                <p>
                                                    <a href="https://www.npmjs.com/package/@microsoft/teams-js">パッケージ</a>
                                                </p>
                                                <p>
                                                    <a
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>ボットおよびメッセージング拡張機能用 Node.js Bot Framework SDK</h3>
                                                <p>
                                                    <a href="https://github.com/Microsoft/BotBuilder-Samples">サンプル</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>ボットおよびメッセージング拡張機能用 .NET Bot Framework SDK</h3>
                                                <p>
                                                    <a href="https://github.com/Microsoft/BotBuilder-Samples">サンプル</a>
                                                </p>
                                                <p>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://docs.microsoft.com/graph/sdks/sdks-overview">Graph SDK の概要</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/graph/sdks/sdk-installation">Graph SDK をインストールする</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/microsoftteams/platform/concepts/build-and-test/app-studio-overview">ドキュメント</a>
                                                </p>
                                                <p>
                                                    <a href="https://aka.ms/InstallTeamsAppStudio">Teams に App Studio をインストールする</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Microsoft Teams 用 Yeoman ジェネレーター</h3>
                                                <p>
