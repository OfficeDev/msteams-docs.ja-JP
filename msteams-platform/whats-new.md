...
| 日付 | Update | ここで検索する  |
| --- | --- | --- |
| 12/09/2021| 会議サイド パネルを作成するステップ バイ ステップ ガイドが導入されました。 | 会議用アプリTeamsを>会議用アプリを有効にして構成する > 手順ガイドを使用して、会議サイド[パネル](sbs-meetings-sidepanel.yml)を作成Teams|
| 12/09/2021| ミーティング ステージ ビューにステップ バイ ステップ ガイドが導入されました。 | 会議のアプリTeams作成>会議のアプリを有効にして構成する > ステップ バイ ステップ ガイドを使用して、会議ステージ ビュー[を作成する](sbs-meetings-stage-view.yml)| 
