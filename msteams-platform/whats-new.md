...
|06/05/2020| マニフェスト スキーマがバージョン 1.7 に更新されました。| [リファレンス: マニフェスト スキーマのMicrosoft Teams](resources/schema/manifest-schema.md)|
