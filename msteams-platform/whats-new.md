...
| 日付 | Update | ここで検索する  |
| --- | --- | --- |
|12/20/2021 | SaaS オファーにリンクされたアプリのガイドラインが導入されました。 | アプリの配布 > 発行する Teams ストア>レビュー ストア検証ガイドライン > [SaaS](concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md#apps-linked-to-saas-offer)オファーにリンクされたアプリのガイドライン|
