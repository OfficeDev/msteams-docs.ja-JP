...
3. CSS をタブ コンテンツのルート HTML 要素 ( ) に適用します `<div style={newTheme}>` 。
...
* 設計ガイドライン [に従い](../tabs/design/tabs.md) 、実稼働環境対応 [の UI](../concepts/design/design-teams-app-ui-templates.md) テンプレートを使用してビルドし、シームレスなエクスペリエンスを作成します。
