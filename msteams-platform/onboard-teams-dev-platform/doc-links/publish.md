...
---
# <a name="understanding-the-appsource-submission-process"></a>AppSource 送信プロセスについて

## <a name="teams-app-submission"></a>Teams アプリの提出

アプリを [Microsoft AppSource](https://appsource.microsoft.com) に発行することで、Teams アプリカタログと web 上で使用できるようになります。 高レベルでは、アプリを AppSource に提出するプロセスは次のようになります。
