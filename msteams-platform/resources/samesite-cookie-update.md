...
## <a name="cookies-in-brief"></a>簡潔な Cookie
 ...
 |**第二者の Cookie**|第二者の Cookie は、技術的にはファースト パーティ Cookie と同じです。 違いは、データがデータパートナーシップ契約 (分析やレポートなど) を介して第[Microsoft Teams共有される点です](/microsoftteams/teams-analytics-and-reports/teams-reporting-reference)。 |
