...
<span data-ttu-id="18d36-126">アプリでアクセス許可の要求が変更された場合、ユーザーはアプリのアップグレードと再同意を求めるメッセージが表示されます。</span><span class="sxs-lookup"><span data-stu-id="18d36-126">If the app requests for permissions change, the users are prompted to upgrade and re-consent to the app.</span></span>
...
|`mpnId`|<span data-ttu-id="18d36-158">10 文字</span><span class="sxs-lookup"><span data-stu-id="18d36-158">10 characters</span></span>| |<span data-ttu-id="18d36-159">**省略可能** アプリを構築するパートナー組織を識別する Microsoft パートナー ネットワーク ID。</span><span class="sxs-lookup"><span data-stu-id="18d36-159">**Optional** The Microsoft Partner Network ID that identifies the partner organization building the app.</span></span>|
...
## <a name="packagename"></a><span data-ttu-id="18d36-192">packageName</span><span class="sxs-lookup"><span data-stu-id="18d36-192">packageName</span></span>
...
|<span data-ttu-id="18d36-221">名前</span><span class="sxs-lookup"><span data-stu-id="18d36-221">Name</span></span>| <span data-ttu-id="18d36-222">最大サイズ</span><span class="sxs-lookup"><span data-stu-id="18d36-222">Maximum size</span></span> | <span data-ttu-id="18d36-223">必須</span><span class="sxs-lookup"><span data-stu-id="18d36-223">Required</span></span> | <span data-ttu-id="18d36-224">説明</span><span class="sxs-lookup"><span data-stu-id="18d36-224">Description</span></span>|
|---|---|---|---|
...
|`context` |<span data-ttu-id="18d36-256">列挙型の配列</span><span class="sxs-lookup"><span data-stu-id="18d36-256">array of enums</span></span>|<span data-ttu-id="18d36-257">6</span><span class="sxs-lookup"><span data-stu-id="18d36-257">6</span></span>||<span data-ttu-id="18d36-258">タブが `contextItem` サポートされているスコープ [のセット](../../tabs/how-to/access-teams-context.md)です。</span><span class="sxs-lookup"><span data-stu-id="18d36-258">The set of `contextItem` scopes where a [tab is supported](../../tabs/how-to/access-teams-context.md).</span></span> <span data-ttu-id="18d36-259">既定値: **[channelTab, privateChatTab, meetingChatTab, meetingDetailsTab]**.</span><span class="sxs-lookup"><span data-stu-id="18d36-259">Default: **[channelTab, privateChatTab, meetingChatTab, meetingDetailsTab]**.</span></span>|
...
|`websiteUrl`|<span data-ttu-id="18d36-291">string</span><span class="sxs-lookup"><span data-stu-id="18d36-291">string</span></span>|||<span data-ttu-id="18d36-292">ユーザー https:// ブラウザーで表示することを選択した場合に示す URL を指定します。</span><span class="sxs-lookup"><span data-stu-id="18d36-292">The https:// URL to point to if a user opts to view in a browser.</span></span>|
...
|---|---|---|---|---|
|`items.scopes`|<span data-ttu-id="18d36-354">列挙型の配列</span><span class="sxs-lookup"><span data-stu-id="18d36-354">array of enums</span></span>|<span data-ttu-id="18d36-355">3</span><span class="sxs-lookup"><span data-stu-id="18d36-355">3</span></span>|<span data-ttu-id="18d36-356">✔</span><span class="sxs-lookup"><span data-stu-id="18d36-356">✔</span></span>|<span data-ttu-id="18d36-357">コマンド リストが有効なスコープを指定します。</span><span class="sxs-lookup"><span data-stu-id="18d36-357">Specifies the scope for which the command list is valid.</span></span> <span data-ttu-id="18d36-358">`team`、`personal`、`groupchat` の中から選択できます。</span><span class="sxs-lookup"><span data-stu-id="18d36-358">Options are `team`, `personal`, and `groupchat`.</span></span>|
...
|`scopes`|<span data-ttu-id="18d36-395">列挙型の配列</span><span class="sxs-lookup"><span data-stu-id="18d36-395">array of enums</span></span>|<span data-ttu-id="18d36-396">1</span><span class="sxs-lookup"><span data-stu-id="18d36-396">1</span></span>|<span data-ttu-id="18d36-397">✔</span><span class="sxs-lookup"><span data-stu-id="18d36-397">✔</span></span>|<span data-ttu-id="18d36-398">Connector がチャネルのコンテキストでエクスペリエンスを提供するかどうか、または個々のユーザー () にスコープを設定したエクスペリエンスを提供するかどうかを `team` 指定します `personal` 。</span><span class="sxs-lookup"><span data-stu-id="18d36-398">Specifies whether the Connector offers an experience in the context of a channel in a `team`, or an experience scoped to an individual user alone (`personal`).</span></span> <span data-ttu-id="18d36-399">現在、スコープ `team` だけがサポートされています。</span><span class="sxs-lookup"><span data-stu-id="18d36-399">Currently, only the `team` scope is supported.</span></span>|
...
|`messageHandlers.type`|<span data-ttu-id="18d36-430">string</span><span class="sxs-lookup"><span data-stu-id="18d36-430">string</span></span>|||<span data-ttu-id="18d36-431">メッセージ ハンドラーの種類。</span><span class="sxs-lookup"><span data-stu-id="18d36-431">The type of message handler.</span></span> <span data-ttu-id="18d36-432">`"link"` である必要があります。</span><span class="sxs-lookup"><span data-stu-id="18d36-432">Must be `"link"`.</span></span>|
...
|`fetchTask`|<span data-ttu-id="18d36-469">ブール値</span><span class="sxs-lookup"><span data-stu-id="18d36-469">boolean</span></span>|||<span data-ttu-id="18d36-470">タスク モジュールを動的にフェッチする必要があるかどうかを示すブール値。</span><span class="sxs-lookup"><span data-stu-id="18d36-470">A boolean value that indicates if it must fetch the task module dynamically.</span></span> <span data-ttu-id="18d36-471">既定値は **false** です。</span><span class="sxs-lookup"><span data-stu-id="18d36-471">Default is **false**.</span></span>|
...
<span data-ttu-id="18d36-533">アプリがクライアント内で読み込むと予想される Web サイトの有効なドメインTeamsします。</span><span class="sxs-lookup"><span data-stu-id="18d36-533">A list of valid domains for websites the app expects to load within the Teams client.</span></span> <span data-ttu-id="18d36-534">ドメインの一覧には、ワイルドカード (たとえば) を含めできます `*.example.com` 。</span><span class="sxs-lookup"><span data-stu-id="18d36-534">Domain listings can include wildcards, for example, `*.example.com`.</span></span> <span data-ttu-id="18d36-535">これは、ドメインの 1 つのセグメントと完全に一致します。一致する必要がある場合は、 `a.b.example.com` を使用します `*.*.example.com` 。</span><span class="sxs-lookup"><span data-stu-id="18d36-535">This matches exactly one segment of the domain; if you need to match `a.b.example.com` then use `*.*.example.com`.</span></span> <span data-ttu-id="18d36-536">タブ構成またはコンテンツ UI で、タブ構成に使用するドメイン以外のドメインに移動する必要がある場合は、ここでそのドメインを指定する必要があります。</span><span class="sxs-lookup"><span data-stu-id="18d36-536">If your tab configuration or content UI needs to navigate to any other domain besides the one use for tab configuration, that domain must be specified here.</span></span>

<span data-ttu-id="18d36-537">サポート **する** ID プロバイダーのドメインをアプリに含める必要はありません。</span><span class="sxs-lookup"><span data-stu-id="18d36-537">It is **not** necessary to include the domains of identity providers you want to support in your app.</span></span> <span data-ttu-id="18d36-538">たとえば、Google ID を使用して認証を行う場合は、accounts.google.com にリダイレクトする必要があります。ただし、accounts.google.com を含 accounts.google.com 必要があります `validDomains[]` 。</span><span class="sxs-lookup"><span data-stu-id="18d36-538">For example, to authenticate using a Google ID, it is required to redirect to accounts.google.com, however, you must not include accounts.google.com in `validDomains[]`.</span></span>

<span data-ttu-id="18d36-539">Teams機能するために独自の sharepoint URL を必要とするアプリには、有効なドメイン リストに "{teamsitedomain}" が含まれます。</span><span class="sxs-lookup"><span data-stu-id="18d36-539">Teams apps that require their own sharepoint URLs to function well, includes "{teamsitedomain}" in their valid domain list.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="18d36-540">直接またはワイルドカードを使用して、コントロールの外部にあるドメインを追加しません。</span><span class="sxs-lookup"><span data-stu-id="18d36-540">Do not add domains that are outside your control, either directly or through wildcards.</span></span> <span data-ttu-id="18d36-541">たとえば、 `yourapp.onmicrosoft.com` 有効ですが、 `*.onmicrosoft.com` 無効です。</span><span class="sxs-lookup"><span data-stu-id="18d36-541">For example, `yourapp.onmicrosoft.com` is valid, however, `*.onmicrosoft.com` is not valid.</span></span>

<span data-ttu-id="18d36-542">オブジェクトは、型のすべての要素を持つ配列です `string` 。</span><span class="sxs-lookup"><span data-stu-id="18d36-542">The object is an array with all elements of the type `string`.</span></span>

## <a name="webapplicationinfo"></a><span data-ttu-id="18d36-543">webApplicationInfo</span><span class="sxs-lookup"><span data-stu-id="18d36-543">webApplicationInfo</span></span>

<span data-ttu-id="18d36-544">**省略可能** — オブジェクト</span><span class="sxs-lookup"><span data-stu-id="18d36-544">**Optional** — object</span></span>

<span data-ttu-id="18d36-545">ユーザーがアプリAzure Active Directoryシームレスにサインインするのに役立つ、アプリ ID と Microsoft Graph情報を提供します。</span><span class="sxs-lookup"><span data-stu-id="18d36-545">Provide your Azure Active Directory (AAD) App ID and Microsoft Graph information to help users seamlessly sign into your app.</span></span> <span data-ttu-id="18d36-546">アプリが AAD に登録されている場合は、管理者が管理センターでアクセス許可を簡単に確認し、同意を与Teamsする必要があります。</span><span class="sxs-lookup"><span data-stu-id="18d36-546">If your app is registered in AAD, you must provide the App ID, so that administrators can easily review permissions and grant consent in Teams admin center.</span></span>

|<span data-ttu-id="18d36-547">名前</span><span class="sxs-lookup"><span data-stu-id="18d36-547">Name</span></span>| <span data-ttu-id="18d36-548">型</span><span class="sxs-lookup"><span data-stu-id="18d36-548">Type</span></span>| <span data-ttu-id="18d36-549">最大サイズ</span><span class="sxs-lookup"><span data-stu-id="18d36-549">Maximum size</span></span> | <span data-ttu-id="18d36-550">必須</span><span class="sxs-lookup"><span data-stu-id="18d36-550">Required</span></span> | <span data-ttu-id="18d36-551">説明</span><span class="sxs-lookup"><span data-stu-id="18d36-551">Description</span></span>|
|---|---|---|---|---|
|`id`|<span data-ttu-id="18d36-552">string</span><span class="sxs-lookup"><span data-stu-id="18d36-552">string</span></span>|<span data-ttu-id="18d36-553">36 文字</span><span class="sxs-lookup"><span data-stu-id="18d36-553">36 characters</span></span>|<span data-ttu-id="18d36-554">✔</span><span class="sxs-lookup"><span data-stu-id="18d36-554">✔</span></span>|<span data-ttu-id="18d36-555">アプリの AAD アプリケーション ID。</span><span class="sxs-lookup"><span data-stu-id="18d36-555">AAD application id of the app.</span></span> <span data-ttu-id="18d36-556">この ID は GUID である必要があります。</span><span class="sxs-lookup"><span data-stu-id="18d36-556">This id must be a GUID.</span></span>|
|`resource`|<span data-ttu-id="18d36-557">string</span><span class="sxs-lookup"><span data-stu-id="18d36-557">string</span></span>|<span data-ttu-id="18d36-558">2048 文字</span><span class="sxs-lookup"><span data-stu-id="18d36-558">2048 characters</span></span>|<span data-ttu-id="18d36-559">✔</span><span class="sxs-lookup"><span data-stu-id="18d36-559">✔</span></span>|<span data-ttu-id="18d36-560">SSO の認証トークンを取得するためのアプリのリソース URL。</span><span class="sxs-lookup"><span data-stu-id="18d36-560">Resource URL of app for acquiring auth token for SSO.</span></span> </br> <span data-ttu-id="18d36-561">**注:** SSO を使用していない場合は、エラー応答を回避するために、このフィールドにダミーの文字列値をアプリ マニフェストに https://notapplicable 入力してください。</span><span class="sxs-lookup"><span data-stu-id="18d36-561">**NOTE:** If you are not using SSO, ensure that you enter a dummy string value in this field to your app manifest, for example, https://notapplicable to avoid an error response.</span></span> |
|`applicationPermissions`|<span data-ttu-id="18d36-562">文字列の配列</span><span class="sxs-lookup"><span data-stu-id="18d36-562">array of strings</span></span>|<span data-ttu-id="18d36-563">128 文字</span><span class="sxs-lookup"><span data-stu-id="18d36-563">128 characters</span></span>||<span data-ttu-id="18d36-564">詳細なリソース [固有の同意を指定します](../../graph-api/rsc/resource-specific-consent.md#resource-specific-permissions)。</span><span class="sxs-lookup"><span data-stu-id="18d36-564">Specify granular [resource specific consent](../../graph-api/rsc/resource-specific-consent.md#resource-specific-permissions).</span></span>|

## <a name="showloadingindicator"></a><span data-ttu-id="18d36-565">showLoadingIndicator</span><span class="sxs-lookup"><span data-stu-id="18d36-565">showLoadingIndicator</span></span>

<span data-ttu-id="18d36-566">**省略** 可能 - ブール型 (Boolean)</span><span class="sxs-lookup"><span data-stu-id="18d36-566">**Optional** — boolean</span></span>

<span data-ttu-id="18d36-567">アプリまたはタブの読み込み時に読み込みインジケーターを表示するかどうかを示します。</span><span class="sxs-lookup"><span data-stu-id="18d36-567">Indicates whether or not to show the loading indicator when an app or tab is loading.</span></span> <span data-ttu-id="18d36-568">既定値は **false** です。</span><span class="sxs-lookup"><span data-stu-id="18d36-568">Default is **false**.</span></span>
>[!NOTE]
><span data-ttu-id="18d36-569">アプリ マニフェストで true を選択した場合、ページを正しく読み込むには、「ネイティブ読み込みインジケーター ドキュメントを表示する」の説明に従って、タブとタスク モジュールのコンテンツ ページを `showLoadingIndicator` [変更](../../tabs/how-to/create-tab-pages/content-page.md#show-a-native-loading-indicator) します。</span><span class="sxs-lookup"><span data-stu-id="18d36-569">If you select`showLoadingIndicator` as true in your app manifest, to load the page correctly, modify the content pages of your tabs and task modules as described in [Show a native loading indicator](../../tabs/how-to/create-tab-pages/content-page.md#show-a-native-loading-indicator) document.</span></span>


## <a name="isfullscreen"></a><span data-ttu-id="18d36-570">isFullScreen</span><span class="sxs-lookup"><span data-stu-id="18d36-570">isFullScreen</span></span>

 <span data-ttu-id="18d36-571">**省略** 可能 - ブール型 (Boolean)</span><span class="sxs-lookup"><span data-stu-id="18d36-571">**Optional** — boolean</span></span>

<span data-ttu-id="18d36-572">タブ ヘッダー バーの付きまたはなしで個人用アプリがレンダリングされる場所を示します。</span><span class="sxs-lookup"><span data-stu-id="18d36-572">Indicate where a personal app is rendered with or without a tab header bar.</span></span> <span data-ttu-id="18d36-573">既定値は **false** です。</span><span class="sxs-lookup"><span data-stu-id="18d36-573">Default is **false**.</span></span>

## <a name="activities"></a><span data-ttu-id="18d36-574">activities</span><span class="sxs-lookup"><span data-stu-id="18d36-574">activities</span></span>

<span data-ttu-id="18d36-575">**省略可能** — オブジェクト</span><span class="sxs-lookup"><span data-stu-id="18d36-575">**Optional** — object</span></span>

<span data-ttu-id="18d36-576">アプリがユーザー アクティビティ フィードの投稿に使用するプロパティを定義します。</span><span class="sxs-lookup"><span data-stu-id="18d36-576">Define the properties your app uses to post a user activity feed.</span></span>

|<span data-ttu-id="18d36-577">名前</span><span class="sxs-lookup"><span data-stu-id="18d36-577">Name</span></span>| <span data-ttu-id="18d36-578">型</span><span class="sxs-lookup"><span data-stu-id="18d36-578">Type</span></span>| <span data-ttu-id="18d36-579">最大サイズ</span><span class="sxs-lookup"><span data-stu-id="18d36-579">Maximum size</span></span> | <span data-ttu-id="18d36-580">必須</span><span class="sxs-lookup"><span data-stu-id="18d36-580">Required</span></span> | <span data-ttu-id="18d36-581">説明</span><span class="sxs-lookup"><span data-stu-id="18d36-581">Description</span></span>|
|---|---|---|---|---|
|`activityTypes`|<span data-ttu-id="18d36-582">オブジェクトの配列</span><span class="sxs-lookup"><span data-stu-id="18d36-582">array of Objects</span></span>|<span data-ttu-id="18d36-583">128 アイテム</span><span class="sxs-lookup"><span data-stu-id="18d36-583">128 items</span></span>| | <span data-ttu-id="18d36-584">アプリがユーザーアクティビティ フィードに投稿できるアクティビティの種類を指定します。</span><span class="sxs-lookup"><span data-stu-id="18d36-584">Provide the types of activities that your app can post to a users activity feed.</span></span>|

### <a name="activitiesactivitytypes"></a><span data-ttu-id="18d36-585">activity.activityTypes</span><span class="sxs-lookup"><span data-stu-id="18d36-585">activities.activityTypes</span></span>

|<span data-ttu-id="18d36-586">名前</span><span class="sxs-lookup"><span data-stu-id="18d36-586">Name</span></span>| <span data-ttu-id="18d36-587">型</span><span class="sxs-lookup"><span data-stu-id="18d36-587">Type</span></span>| <span data-ttu-id="18d36-588">最大サイズ</span><span class="sxs-lookup"><span data-stu-id="18d36-588">Maximum size</span></span> | <span data-ttu-id="18d36-589">必須</span><span class="sxs-lookup"><span data-stu-id="18d36-589">Required</span></span> | <span data-ttu-id="18d36-590">説明</span><span class="sxs-lookup"><span data-stu-id="18d36-590">Description</span></span>|
|---|---|---|---|---|
|`type`|<span data-ttu-id="18d36-591">string</span><span class="sxs-lookup"><span data-stu-id="18d36-591">string</span></span>|<span data-ttu-id="18d36-592">32 文字</span><span class="sxs-lookup"><span data-stu-id="18d36-592">32 characters</span></span>|<span data-ttu-id="18d36-593">✔</span><span class="sxs-lookup"><span data-stu-id="18d36-593">✔</span></span>|<span data-ttu-id="18d36-594">通知の種類。</span><span class="sxs-lookup"><span data-stu-id="18d36-594">The notification type.</span></span> <span data-ttu-id="18d36-595">*以下を参照してください*。</span><span class="sxs-lookup"><span data-stu-id="18d36-595">*See below*.</span></span>|
|`description`|<span data-ttu-id="18d36-596">string</span><span class="sxs-lookup"><span data-stu-id="18d36-596">string</span></span>|<span data-ttu-id="18d36-597">128 文字</span><span class="sxs-lookup"><span data-stu-id="18d36-597">128 characters</span></span>|<span data-ttu-id="18d36-598">✔</span><span class="sxs-lookup"><span data-stu-id="18d36-598">✔</span></span>|<span data-ttu-id="18d36-599">通知の簡単な説明。</span><span class="sxs-lookup"><span data-stu-id="18d36-599">A brief description of the notification.</span></span> <span data-ttu-id="18d36-600">*以下を参照してください*。</span><span class="sxs-lookup"><span data-stu-id="18d36-600">*See below*.</span></span>|
|`templateText`|<span data-ttu-id="18d36-601">string</span><span class="sxs-lookup"><span data-stu-id="18d36-601">string</span></span>|<span data-ttu-id="18d36-602">128 文字</span><span class="sxs-lookup"><span data-stu-id="18d36-602">128 characters</span></span>|<span data-ttu-id="18d36-603">✔</span><span class="sxs-lookup"><span data-stu-id="18d36-603">✔</span></span>|<span data-ttu-id="18d36-604">例: "{actor} が作成したタスク {taskId} for you"</span><span class="sxs-lookup"><span data-stu-id="18d36-604">Ex: "{actor} created task {taskId} for you"</span></span>|
...
## <a name="defaultinstallscope"></a><span data-ttu-id="18d36-605">defaultInstallScope</span><span class="sxs-lookup"><span data-stu-id="18d36-605">defaultInstallScope</span></span>

<span data-ttu-id="18d36-606">**省略** 可能 - 文字列</span><span class="sxs-lookup"><span data-stu-id="18d36-606">**Optional** - string</span></span>

<span data-ttu-id="18d36-607">既定では、このアプリに対して定義されているインストール スコープを指定します。</span><span class="sxs-lookup"><span data-stu-id="18d36-607">Specifies the install scope defined for this app by default.</span></span> <span data-ttu-id="18d36-608">定義されたスコープは、ユーザーがアプリを追加しようとするときにボタンに表示されるオプションになります。</span><span class="sxs-lookup"><span data-stu-id="18d36-608">The defined scope will be the option displayed on the button when a user tries to add the app.</span></span> <span data-ttu-id="18d36-609">オプションは、次のとおりです。</span><span class="sxs-lookup"><span data-stu-id="18d36-609">Options are:</span></span>
* `personal`
* `team`
* `groupchat`
* `meetings`

## <a name="defaultgroupcapability"></a><span data-ttu-id="18d36-610">defaultGroupCapability</span><span class="sxs-lookup"><span data-stu-id="18d36-610">defaultGroupCapability</span></span>

<span data-ttu-id="18d36-611">**省略可能** - オブジェクト</span><span class="sxs-lookup"><span data-stu-id="18d36-611">**Optional** - object</span></span>

<span data-ttu-id="18d36-612">グループ インストール スコープを選択すると、ユーザーがアプリをインストールするときに既定の機能が定義されます。</span><span class="sxs-lookup"><span data-stu-id="18d36-612">When a group install scope is selected, it will define the default capability when the user installs the app.</span></span> <span data-ttu-id="18d36-613">オプションは、次のとおりです。</span><span class="sxs-lookup"><span data-stu-id="18d36-613">Options are:</span></span>
* `team`
* `groupchat`
* `meetings`
 
|<span data-ttu-id="18d36-614">名前</span><span class="sxs-lookup"><span data-stu-id="18d36-614">Name</span></span>| <span data-ttu-id="18d36-615">型</span><span class="sxs-lookup"><span data-stu-id="18d36-615">Type</span></span>| <span data-ttu-id="18d36-616">最大サイズ</span><span class="sxs-lookup"><span data-stu-id="18d36-616">Maximum size</span></span> | <span data-ttu-id="18d36-617">必須</span><span class="sxs-lookup"><span data-stu-id="18d36-617">Required</span></span> | <span data-ttu-id="18d36-618">説明</span><span class="sxs-lookup"><span data-stu-id="18d36-618">Description</span></span>|
|---|---|---|---|---|
|`team`|<span data-ttu-id="18d36-619">string</span><span class="sxs-lookup"><span data-stu-id="18d36-619">string</span></span>|||<span data-ttu-id="18d36-620">選択したインストール スコープが次の場合 `team` 、このフィールドは使用可能な既定の機能を指定します。</span><span class="sxs-lookup"><span data-stu-id="18d36-620">When the install scope selected is `team`, this field specifies the default capability available.</span></span> <span data-ttu-id="18d36-621">オプション: `tab` `bot` 、、または `connector` 。</span><span class="sxs-lookup"><span data-stu-id="18d36-621">Options: `tab`, `bot`, or `connector`.</span></span>|
|`groupchat`|<span data-ttu-id="18d36-622">string</span><span class="sxs-lookup"><span data-stu-id="18d36-622">string</span></span>|||<span data-ttu-id="18d36-623">選択したインストール スコープが次の場合 `groupchat` 、このフィールドは使用可能な既定の機能を指定します。</span><span class="sxs-lookup"><span data-stu-id="18d36-623">When the install scope selected is `groupchat`, this field specifies the default capability available.</span></span> <span data-ttu-id="18d36-624">オプション: `tab` `bot` 、、または `connector` 。</span><span class="sxs-lookup"><span data-stu-id="18d36-624">Options: `tab`, `bot`, or `connector`.</span></span>|
|`meetings`|<span data-ttu-id="18d36-625">string</span><span class="sxs-lookup"><span data-stu-id="18d36-625">string</span></span>|||<span data-ttu-id="18d36-626">選択したインストール スコープが次の場合 `meetings` 、このフィールドは使用可能な既定の機能を指定します。</span><span class="sxs-lookup"><span data-stu-id="18d36-626">When the install scope selected is `meetings`, this field specifies the default capability available.</span></span> <span data-ttu-id="18d36-627">オプション: `tab` `bot` 、、または `connector` 。</span><span class="sxs-lookup"><span data-stu-id="18d36-627">Options: `tab`, `bot`, or `connector`.</span></span>|

## <a name="configurableproperties"></a><span data-ttu-id="18d36-628">configurableProperties</span><span class="sxs-lookup"><span data-stu-id="18d36-628">configurableProperties</span></span>

<span data-ttu-id="18d36-629">**オプション** - 配列</span><span class="sxs-lookup"><span data-stu-id="18d36-629">**Optional** - array</span></span>

<span data-ttu-id="18d36-630">この `configurableProperties` ブロックは、管理者がカスタマイズできるアプリTeams定義します。</span><span class="sxs-lookup"><span data-stu-id="18d36-630">The `configurableProperties` block defines the app properties that Teams admin can customize.</span></span> <span data-ttu-id="18d36-631">詳細については、「アプリのカスタマイズ[」を参照Microsoft Teams。](/MicrosoftTeams/customize-apps)</span><span class="sxs-lookup"><span data-stu-id="18d36-631">For more information, see [customize apps in Microsoft Teams](/MicrosoftTeams/customize-apps).</span></span>

> [!NOTE]
> <span data-ttu-id="18d36-632">少なくとも 1 つのプロパティを定義する必要があります。</span><span class="sxs-lookup"><span data-stu-id="18d36-632">A minimum of one property must be defined.</span></span> <span data-ttu-id="18d36-633">このブロックでは、最大 9 つのプロパティを定義できます。</span><span class="sxs-lookup"><span data-stu-id="18d36-633">You can define a maximum of nine properties in this block.</span></span>
> <span data-ttu-id="18d36-634">ベスト プラクティスとして、アプリのユーザーとユーザーがアプリをカスタマイズするときに従うカスタマイズ ガイドラインを提供する必要があります。</span><span class="sxs-lookup"><span data-stu-id="18d36-634">As a best practice, you must provide customization guidelines for app users and customers to follow when customizing your app.</span></span>

<span data-ttu-id="18d36-635">次のプロパティを定義できます。</span><span class="sxs-lookup"><span data-stu-id="18d36-635">You can define any of the following properties:</span></span>
* <span data-ttu-id="18d36-636">`name`: 管理者がアプリの表示名を変更できます。</span><span class="sxs-lookup"><span data-stu-id="18d36-636">`name`: Allows admin to change the app's display name.</span></span>
* <span data-ttu-id="18d36-637">`shortDescription`: 管理者がアプリの簡単な説明を変更できます。</span><span class="sxs-lookup"><span data-stu-id="18d36-637">`shortDescription`: Allows admin to change the app's short description.</span></span>
* <span data-ttu-id="18d36-638">`longDescription`: 管理者がアプリの詳細な説明を変更できます。</span><span class="sxs-lookup"><span data-stu-id="18d36-638">`longDescription`: Allows admin to change the app's detailed description.</span></span>
* <span data-ttu-id="18d36-639">`smallImageUrl`: マニフェストの `outline` ブロック内 `icons` のプロパティです。</span><span class="sxs-lookup"><span data-stu-id="18d36-639">`smallImageUrl`: It is the `outline` property in the `icons` block of the manifest.</span></span>
* <span data-ttu-id="18d36-640">`largeImageUrl`: マニフェストの `color` ブロック内 `icons` のプロパティです。</span><span class="sxs-lookup"><span data-stu-id="18d36-640">`largeImageUrl`: It is the `color` property in the `icons` block of the manifest.</span></span>
* <span data-ttu-id="18d36-641">`accentColor`: アウトライン アイコンと組み合わせて、背景として使用する色です。</span><span class="sxs-lookup"><span data-stu-id="18d36-641">`accentColor`: It is the color to use in conjunction with and as a background for your outline icons.</span></span>
* <span data-ttu-id="18d36-642">`websiteUrl`: 開発者の https:// の URL です。</span><span class="sxs-lookup"><span data-stu-id="18d36-642">`websiteUrl`: It is the https:// URL to the developer's website.</span></span>
* <span data-ttu-id="18d36-643">`privacyUrl`: 開発者の https:// の URL です。</span><span class="sxs-lookup"><span data-stu-id="18d36-643">`privacyUrl`: It is the https:// URL to the developer's privacy policy.</span></span>
* <span data-ttu-id="18d36-644">`termsOfUseUrl`: 開発者の https:// の URL です。</span><span class="sxs-lookup"><span data-stu-id="18d36-644">`termsOfUseUrl`: It is the https:// URL to the developer's terms of use.</span></span>
