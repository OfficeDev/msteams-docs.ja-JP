...
ms.locfileid: "58345361"
---
# <a name="prerequisites-and-api-references-for-apps-in-teams-meetings"></a>Teams 会議アプリへの前提条件と API リファレンス

会議のライフサイクル全体にわたってアプリの機能を拡張するには、Teams会議のアプリを操作Teamsできます。 前提条件を確認し、会議アプリ API 参照を使用して会議のエクスペリエンスを強化します。

## <a name="prerequisites"></a>前提条件

会議のアプリを使用するTeams、次の前提条件について理解している必要があります。
